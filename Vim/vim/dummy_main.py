...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='/root/autodl-tmp/project/MedSAM-0.1/data/MULTI_TUMOR_split', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='TUMOR', choices=['CIFAR', 'IMNET', 'TUMOR', 'INAT', 'INAT19'],
    ...
    parser.add_argument('--output_dir',
                        default='./output/vim_small_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_with_midclstok_div2',
...
def main(args):
    ...
    args.nb_classes = 3 # Set the number of classes
